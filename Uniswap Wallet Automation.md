# Uniswap Wallet Automation

Below is the Java code for automating actions on the Uniswap website using Selenium.
...
public class UniswapWalletAutomation {
    ...
    public static void main(String[] args) {
        ...
        // This code can be added if we want to add Metamask extension in New session of chrome
